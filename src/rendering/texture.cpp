...
basicTexture::basicTexture(basicTexture&& other) noexcept {
    aTexture = other.aTexture;
    width = other.width;
    height = other.height;
    other.aTexture = nullptr;  // Prevent deletion in destructor
}

basicTexture& basicTexture::operator=(basicTexture&& other) noexcept {
    if (this != &other) {
        free();
        aTexture = other.aTexture;
        width = other.width;
        height = other.height;
        other.aTexture = nullptr;
    }
    return *this;
}
